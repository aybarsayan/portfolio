...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/aybarsayan",
    icon: (
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="font-medium">+90 545 661 2337</span>
              </motion.div>
              ...
              >
                ...
                <a 
                  href="mailto:aybarsayan@gmail.com" 
                  className="font-medium text-gray-700 hover:text-[#698f60] transition-colors"
                >
                  aybarsayan@gmail.com
                </a>
              </motion.div>
            </div>
                ...
                {socialLinks.map((link) => (
                  <li key={link.name}>
                    <a
                      ...
                      className="text-gray-600 hover:text-[#698f60] transition-colors flex items-center gap-2 group"
                    >
